...
show_help() {
    ...
    echo "                            Format: owner/repo  (e.g. dialtone867/SRTM-tool)"
    ...
    echo "  $0 --github-only --from-github dialtone867/SRTM-tool  # GitHub artifacts only"
    echo "  $0 --from-github dialtone867/SRTM-tool           # Explicit repo"
